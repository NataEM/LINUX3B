...
- Intento inicial (apuntando a directorio):
  ```bash
  alias ir_notas='laboratorio/proyectos/movil'
  ```
- Intento final correcto (abriendo directamente con nano):
  ```bash
